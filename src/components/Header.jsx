...
import  brainwave  from '../assets/new_modern.png'
  ...
  return (
    ...
    border-n-6 lg:bg-n-8/90 lg:backdrop-blur-sm ${openNavigation ? 'bg-n-8' : 'bg-n-8/90 backdrop-blur-sm'}`}>
        <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
            ...
            <a className='block w-[8rem] pt-0 xl:mr-8' href='#hero'>
                <img src={brainwave} width={160} height={80} alt='Brainwave' /> 
            </a>
        
            <nav className={`${openNavigation ? 'flex' : 'hidden'} fixed top-[14rem] left-0 right-0 bottom-0 
